...
@section('content')
  ...
  <section class="relative w-full h-screen flex items-center justify-start text-white overflow-hidden">
    <!-- Background Image -->
    <img src="{{ asset('images/smk_homepage.png') }}" alt="SMK Kristen Immanuel"
    ...
    <div class="max-w-6xl mx-auto text-center">
      ...
      <div class="grid md:grid-cols-2 gap-6 items-center">
        ...
        <div class="rounded-2xl overflow-hidden shadow-lg">
          <img src="{{ asset('images/paskibra.jpg') }}" alt="Upacara SMK Kristen Immanuel"
        ...
        <div class="grid grid-rows-2 gap-6">
          <div class="rounded-2xl overflow-hidden shadow-lg">
            <img src="{{ asset('images/osis.jpg') }}" alt="Kegiatan Belajar SMK Kristen Immanuel"
              class="w-full h-52 md:h-64 object-cover hover:scale-105 transition-transform duration-700 ease-in-out">
          </div>
          <div class="rounded-2xl overflow-hidden shadow-lg">
            <img src="{{ asset('images/hari_guru.jpg') }}" alt="Acara Sekolah SMK Kristen Immanuel"
  ...
  <section id="about" class="max-w-6xl mx-auto px-6 my-20">
    <div class="md:flex md:items-center md:space-x-10">
      <div class="relative w-full md:w-1/2 mb-8 md:mb-0 group">
        ...
        <img src="{{ asset('images/smk.jpg') }}" alt="SMK Kristen Immanuel"
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div class="relative rounded-2xl overflow-hidden shadow-lg">
          <div class="w-full h-80 overflow-hidden">
            <img src="{{ asset('images/satria.jpg') }}" alt="Akreditasi & Pengakuan"
        ...
        <div class="relative rounded-2xl overflow-hidden shadow-lg">
          <div class="w-full h-80 overflow-hidden">
            <img src="{{ asset('images/band.jpg') }}" alt="Keterampilan Lewat Ekstrakurikuler"
        ...
        <div class="relative rounded-2xl overflow-hidden shadow-lg">
          <div class="w-full h-80 overflow-hidden">
            <img src="{{ asset('images/studio.jpg') }}" alt="Infrastruktur yang Lengkap"
              class="w-full h-full object-cover transition-transform duration-700 ease-in-out hover:scale-105 will-change-transform">
          </div>
          <div class="absolute inset-0 flex items-end">
            <div class="w-full p-6 text-left text-white bg-gradient-to-t from-black/60 to-transparent">
      ...
      <div id="carouselContainer" class="overflow-hidden cursor-grab active:cursor-grabbing">
        <div id="carouselTrack" class="flex gap-4 w-max transition-transform duration-300 ease-out">
          <div class="flex-shrink-0 w-[300px] md:w-[400px] rounded-2xl overflow-hidden shadow-lg">
            <img src="{{ asset('images/aksos.jpg') }}"
              class="w-full h-[250px] object-cover select-none pointer-events-none" alt="" draggable="false">
          </div>
          <div class="flex-shrink-0 w-[300px] md:w-[400px] rounded-2xl overflow-hidden shadow-lg">
            <img src="{{ asset('images/mtc.jpg') }}" class="w-full h-[250px] object-cover select-none pointer-events-none"
              alt="" draggable="false">
          </div>
          <div class="flex-shrink-0 w-[300px] md:w-[400px] rounded-2xl overflow-hidden shadow-lg">
            <img src="{{ asset('images/senam_bersama.jpg') }}"
              class="w-full h-[250px] object-cover select-none pointer-events-none" alt="" draggable="false">
          </div>
          <div class="flex-shrink-0 w-[300px] md:w-[400px] rounded-2xl overflow-hidden shadow-lg">
            <img src="{{ asset('images/mpls.jpg') }}"
              class="w-full h-[250px] object-cover select-none pointer-events-none" alt="" draggable="false">
          </div>
          <div class="flex-shrink-0 w-[300px] md:w-[400px] rounded-2xl overflow-hidden shadow-lg">
            <img src="{{ asset('images/immafest.jpg') }}"
              class="w-full h-[250px] object-cover select-none pointer-events-none" alt="" draggable="false">
          </div>
        </div>
      </div>
    ...
    <div class="max-w-7xl mx-auto text-center">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div
          ...
          <img src="{{ asset('images/gaia.jpg') }}" alt="Uncover the Stars" class="w-full h-64 object-cover">
        ...
        <div
          class="bg-white rounded-2xl shadow-md overflow-hidden transform hover:scale-[1.03] transition-transform duration-500 ease-in-out">
          <img src="{{ asset('images/muspus.jpg') }}" alt="Festival Musikalisasi Puisi"
        ...
        <div
          class="bg-white rounded-2xl shadow-md overflow-hidden transform hover:scale-[1.03] transition-transform duration-500 ease-in-out">
          <img src="{{ asset('images/smanta.jpg') }}" alt="SMANTA" class="w-full h-64 object-cover">
          <div class="p-6 text-left">
